...
const ChartPage = (props) => {
    ...
    return (
        ...
        <section>
            <div
                className="fixed bottom-10 left-10 w-16 h-16 bg-zinc-800 p-2 shadow-2xl rounded-full z-10 flex items-center justify-center"
            >
                <button
            ...
            <div className="fixed top-10 left-10 w-60 h-80 bg-zinc-800 p-4 shadow-2xl sm:rounded-3xl z-10 text-center">
                ...
                onClick={() => scrollToChart(barChartRef)}
                    >
                     <img src={BarChartImage} alt="Bar Chart" className="w-full h-full object-cover rounded-lg" />
                </div>
                <div 
